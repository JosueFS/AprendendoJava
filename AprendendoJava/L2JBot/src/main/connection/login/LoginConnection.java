...
/**
 * Class responsible for managing the packages between client <-> server until
 * the selection of "server"
 *
 * @author fissban
 */
                    ...
                    switch (data[0] & 0xFF) // opcode
                    {
                        ...
                        case LoginServerToClientCodes.LOGIN_FAILED: {
                            ...
                            while (option == JOptionPane.CANCEL_OPTION) {
                                JOptionPane.showConfirmDialog(getActualFrame(), fail.getReason(), "Login", WebOptionPane.ERROR_MESSAGE);
