...
public abstract class Ai implements Runnable {
    ...
    /**
     * It is checked if the list of buffs already defined are present in the
     * effects and are used otherwise.<br>
     * Wait 2 seconds to give time to the buff to be released, it seems that
     * this time is more than enough.<br>
     * If the bot is attacking or using other skills, it will wait until the
    ...
    /**
     * - Check if the hp or mp is very low and if yes the bot will sit down. ->
     * setIntention:RESTING<br>
     * - Check if the hp and mp are complete and if the bot is sitting up. ->
     * setIntention:NONE
     */
    ...
    /**
     * Searches for the drops around the bot and select one, only if
     * {@link #LOOT_ALL_ITEMS} is activated
     *
     * @return
     */
    ...
    /**
     * Search in {@link #RADIO_ATTACK} all possible targets to attack and you
     * get the closest one.
     *
     * @return
     */
    ...
    /**
     * Active auto shots Send packets: {@link RequestAutoSoulShot}
     *
     * @param shot
     */
    ...
    /**
     * Use Magic<br>
     * It will be used only for the launch of non-offensive skills, otherwise
     * use <b><font color=FF0000>attackMagic.</font></b><br>
     * Send packets: {@link Action} -> {@link RequestMagicSkillUse}<br>
     * Change Intention {@link main.enums.EIntention#ATTACKING}<br>
     *
     * @param objectId
    ...
    /**
     * This method serves to invoke the action of sitting or stopping according
     * to the current state of the bot. Send packets: {@link RequestActionUse}
     */
    ...
    /**
     * It looks for the first <b>damage</b> skill that its reuse is less than 15
     * milliseconds,<br>
    ...
    /**
     * It looks for the first <b>debuff</b> skill that its reuse is less than 15
     * milliseconds,<br>
     * in case of not finding a match it will return -1.
     *
     * @return
    ...
    /**
     * Return actual target, if you do not have a target it will return null as
     * a value.
     *
     * @return
     */
