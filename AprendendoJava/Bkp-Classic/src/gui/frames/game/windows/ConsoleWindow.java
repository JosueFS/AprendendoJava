...
/**
 * Here you try to emulate the console "cmd" and thus be able to get all the
 * errors generated from the try and avoid using a bat to see them
 *
 * @author fissban
 */
public class ConsoleWindow extends WebFrame {
    ...
    /**
     * It will be used in <b>try & catch</b> to capture all messages generated
     * from errors.<br>
     * Any other message that you want to appear in the console using
