...
public class Connect extends BFrame {
    ...
    private void init() {
        ...
        FButton btnConnect = new FButton("Conectar");
        ...
        WebCheckBox record = new WebCheckBox("Lembrar IP");
        record.setRound(4);
        ...
        WebLabel lblNewLabel = new WebLabel(" Por favor, seleciona a versão que deseja utilizar.");
        ...
        WebLabel c4Name = new WebLabel("C4 - Scions of Destiny");
        ...
        WebLabel classicIcon = new WebLabel("CL");
        classicIcon.setBackground(new Color(1, 50, 67));
        classicIcon.setDrawShade(true);
        classicIcon.setShadeColor(new Color(153, 102, 0));
        classicIcon.setFont(new Font("Tahoma", Font.PLAIN, 22));
        classicIcon.setHorizontalTextPosition(SwingConstants.CENTER);
        classicIcon.setHorizontalAlignment(SwingConstants.CENTER);
        classicIcon.setForeground(new Color(51, 204, 0));
        classicIcon.setBounds(473, 420, 64, 64);
        classicIcon.setIcon(Img.create("general/icons/cronical2.png", classicIcon.getWidth(), classicIcon.getHeight()));
        getContentPane().add(classicIcon);

        WebLabel classicName = new WebLabel("Classic");
        classicName.setDrawShade(true);
        classicName.setShadeColor(new Color(0, 0, 0));
        classicName.setFont(new Font("Tahoma", Font.BOLD, 11));
        classicName.setForeground(new Color(0, 204, 0));
        classicName.setHorizontalTextPosition(SwingConstants.CENTER);
        classicName.setHorizontalAlignment(SwingConstants.CENTER);
        classicName.setBounds(456, 483, 100, 20);
        getContentPane().add(classicName);

        WebLabel c6Icon = new WebLabel("IL");
        ...
        classicIcon.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                ChronicleManager.set(EChronicle.CL);
                selectChronicle = true;
    ...
    private void btnConnect() {
        SwingUtilities.invokeLater(()
                -> {
            if (!selectChronicle) {
                WebOptionPane.showMessageDialog(this, "Selecione a vers�o!", "Login", JOptionPane.WARNING_MESSAGE);
                return;
            }
    ...
    public static void main(String[] args) {
        try {
            ...
            ConsoleWindow.getInstance().print("Erro ao abrir.", e);
        }
    }
}
